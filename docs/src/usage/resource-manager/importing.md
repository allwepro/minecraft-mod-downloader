...
*   **Flux List Files (`.toml`, `.mmd`):**
    *   These are Flux's native or compatible formats for comprehensive list exports.
...
3.  Choose the **Resource Type** you want to detect (e.g., `Mod`, `Shader`, `Resource Pack`). This helps Flux focus its scan.
...
3.  **Minecraft Version:** Select the target Minecraft version for this list. Flux may suggest a version based on its scan.
4.  **Game Loader:** Select the desired game loader (e.g., Fabric, Forge, Quilt). Flux may suggest a loader.
